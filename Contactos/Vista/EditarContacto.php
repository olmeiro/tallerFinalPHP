                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="">Estado del Contacto</label>
                          <select id="Estado"  name= "Estado" class="form-control">
                              ...
                              ?>
                              <option value="<?php echo $valores['IdEstado']?>" <?php if($Contacto->getEstado()==$valores['IdEstado']){ ?> selected <?php } ?> ><?php echo $valores['Estado']?></option>;
                              <?php
                              }
                              ?>
                          </select>
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-12">
                        ...
                        <button type="button" class="btn btn-outline-dark  btn-lg"><a href="../../navegar.php" style="color:black;">Volver</button>
                      </div>
                  </div>
