...
<html lang="en" dir="ltr">
  ...
  <nav class="navbar navbar-dark bg-primary">
                  ...
                  <br>
            <form action="../Controlador/ControladorEstado.php" method="POST" id="frmEditarEstado" name="frmEditarEstado">

            <div class="form-group col-md-12">
                    <label for="Nombre">Id Del Estado</label>
                    <input type="text" class="form-control" id="IdEstado" name="IdEstado"  value="<?php echo $Estado->getIdEstado(); ?>">
