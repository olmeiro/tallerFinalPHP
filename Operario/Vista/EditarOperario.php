...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <form id="frmEditarOperario" name="frmEditarOperario" action="../Controlador/ControladorOperario.php" method="post">
        ...
        <input class="form-control" type="text" name="NombreOperario" id="NombreOperario" value="<?php echo $Operario->getNombre(); ?>">
       ...
       <input class="form-control" type="text" name="ApellidoOperario" id="ApellidoOperario" value="<?php echo $Operario->getApellido(); ?>">
       <small id="valApellidoOperario" class="form-text text-muted">
        ...
        <input class="form-control" type="text" name="Documento" id="Documento" value="<?php echo $Operario->getDocumento(); ?>">
        ...
        <input class="form-control" type="number" id="Celular" name="Celular" value="<?php echo $Operario->getCelular(); ?>">
        ...
        <button type="submit" class="btn btn-primary btn-lg" id="Modificar" name="Modificar">Registrar Operario</button>
